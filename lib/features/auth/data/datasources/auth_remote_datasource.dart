  ...
  Future<String> sendOtp(String phone) {
    ...
    firebaseAuth.verifyPhoneNumber(
      ...
      verificationCompleted: (PhoneAuthCredential credential) {
        // Auto-retrieval path (Android). Not used for manual entry; kept to
        // satisfy the API. Callers still use verifyOtp with manual code.
  ...
  Future<String> verifyOtp(String verificationId, String smsCode) async {
    ...
    if (uid == null) {
      throw FirebaseAuthException(
        code: 'no-user',
        message: 'Authentication did not return a user.',
      );
    }
    return uid;
  }
