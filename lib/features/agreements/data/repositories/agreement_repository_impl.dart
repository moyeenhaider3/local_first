...
class AgreementRepositoryImpl implements AgreementRepository {
  ...
  @override
  Future<Either<Failure, List<RequestEntity>>> getInboundRequests(String receiverId) async {
    try {
  ...
  @override
  Future<Either<Failure, List<RequestEntity>>> getOutboundRequests(String requesterId) async {
    try {
      final requests = await remoteDatasource.fetchOutboundRequests(requesterId);
      return Right(requests);
    } catch (e) {
      return Left(ServerFailure(e.toString()));
    }
  ...
  @override
  Future<Either<Failure, AgreementEntity>> acceptRequest(String requestId) async {
    try {
  ...
  @override
  Future<Either<Failure, AgreementEntity>> getAgreement(String agreementId) async {
    try {
  ...
  @override
  Future<Either<Failure, List<AgreementEntity>>> getAgreementsByUser(String userId) async {
    try {
